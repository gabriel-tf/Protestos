...
function scene:createScene( event )
	local group = self.view
		...
		gameBg = display.newImage('images/rua_2.png',0, -45)
		group:insert(gameBg)	
		...
		addObstacle(80, 50, 'images/rock2', false, 'l', 'stuff')
		addObstacle(100, 235, 'images/rock2', false, 'l', 'stuff')
		addObstacle(274, 235, 'images/rock2', false, 'l', 'stuff')
		addObstacle(0, 235, 'images/rock2', false, 'l', 'stuff')
		addObstacle(184, 145, 'images/rock2', false, 'l', 'stuff')
		addObstacle(4, 50, 'images/rock2', false, 'l', 'stuff')
		addObstacle(300, 320, 'images/rock2', true, 'l', 'stuff')	
	
		addObstacle(200, 0, 'images/grenede2', true, 'r', 'stuff')
		addObstacle(80, 0, 'images/grenede2', true, 'r', 'stuff')
		addObstacle(0, 185, 'images/grenede2', true, 'r', 'stuff')
		addObstacle(150, 185, 'images/grenede2', true, 'r', 'stuff')
		addObstacle(75, 275, 'images/grenede2', true, 'r', 'stuff')
		addObstacle(300, 275, 'images/grenede2', true, 'r', 'stuff')
		addObstacle(4, 100, 'images/grenede2', true, 'r', 'stuff')
	...
	local function nextGameTouch(event)
		if(event.phase == "began") then
			storyboard.gotoScene("game_3", {effect = "slideDown", time = 900, params = { time = time}})
		end
		display.remove(menuBtn)
		display.remove(nextBtn)
	end
