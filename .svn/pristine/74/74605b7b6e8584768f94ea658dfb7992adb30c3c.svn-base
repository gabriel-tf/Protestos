...
function scene:createScene( event )
	local group = self.view
		...
		gameBg = display.newImage('images/rua_1.png',0, -45)
		group:insert(gameBg)	
		...
		addObstacle(80, 60, 'images/rock', false, 'l', 'stuff')
		addObstacle(94, 225, 'images/rock', false, 'l', 'stuff')
		addObstacle(274, 225, 'images/rock', false, 'l', 'stuff')
		addObstacle(34, 225, 'images/rock', false, 'l', 'stuff')
		addObstacle(184, 145, 'images/rock', false, 'l', 'stuff')
		addObstacle(4, 60, 'images/rock', false, 'l', 'stuff')
	
		addObstacle(4, 10, 'images/grenede', true, 'r', 'stuff')
		addObstacle(80, 10, 'images/grenede', true, 'r', 'stuff')
		addObstacle(94, 180, 'images/grenede', true, 'r', 'stuff')
		addObstacle(34, 265, 'images/grenede', true, 'r', 'stuff')
		addObstacle(4, 100, 'images/grenede', true, 'r', 'stuff')
		
		group:insert(obstacles)	
		
		local g1= display.newImage("images/chegada.png", 0, -45)
		g1.name = 'goal'
		...
		policia = display.newImage('images/policia1.png', -10, -95)
		physics.addBody( policia, "static" )
		group:insert(policia)			
		
		manifestantes = display.newImage('images/manifestantes1.png', 285, -95)
		...
		down = display.newImage('images/seta_down.png', 248, 468)
		up = display.newImage('images/seta_up.png', 248, 415)
		...
		player:play()
		physics.addBody(player, 'dynamic',{ radius = '22'})
	...
	local function nextGameTouch(event)
		if(event.phase == "began") then	
			storyboard.gotoScene("game_2", {effect = "slideDown", time = 900, params = { time = time}})
		end
		display.remove(menuBtn)
		display.remove(nextBtn)
	end
	...
	function alert(action)
		...
		if(action == 'lose') then
			...
			timer.pause(timerInGame)
			nextBtn = display.newImage('images/next_button.png', 70, 300)
			menuBtn = display.newImage('images/menu_button.png', 113, 360)
